    ...
    public class FromSwaggerJsonRequestGenerator
    {
        public async Task RunAsync(string bin, string targetNamespace)
        {
            ...
            foreach (var template in apiMethods.Keys)
            {
                ...
                var pluralizedParentNamespace = PascalCasePropertyNameGenerator.ConvertToPascalCase(method.ParentNamespace).Pluralize();
                ...
                sb.AppendLine();
                sb.AppendLine($"namespace CapitolSharp.Congress.{pluralizedParentNamespace}");
                sb.AppendLine("{");
